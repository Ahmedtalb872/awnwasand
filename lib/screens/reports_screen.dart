...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  late Future<FinancialReport> _reportFuture;

  @override
  void initState() {
    super.initState();
    _reportFuture = _expensesRepository.fetchReport();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder<FinancialReport>(
          ...
          builder: (context, snapshot) {
            ...
            return ListView(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: _StatCard(
                        ...
                        value: '${report.totalExpenses} ر.س',
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            DonutChart(categories: report.categories),
                ...
                PrimaryButton(label: 'عرض جميع التقارير', onPressed: () {}),
              ],
            );
          },
        ),
